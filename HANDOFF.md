# Passation — état du projet au 2026-08-19

> Document destiné à quelqu'un qui **reprend le projet sans contexte**.
> Lis celui-ci en premier, puis [`SNAPL-TESTMODE.md`](./SNAPL-TESTMODE.md).
